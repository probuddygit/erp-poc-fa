...
export function seed(): CrmState {
  return {
    ...
    opportunities: [
      { id: "o1", code: "OPP-3001", name: "EV Battery Tray BIW Line", customerName: "Tata Motors — Pune", value: 8500000, probability: 65, stage: "proposal", owner: "R. Iyer", expectedClose: days(30), createdAt: days(-10) },
      { id: "o2", code: "OPP-3002", name: "Underbody Weld Cell Upgrade", customerName: "Mahindra Auto", value: 4200000, probability: 40, stage: "qualified", owner: "S. Kapoor", expectedClose: days(45), createdAt: days(-7) },
      { id: "o3", code: "OPP-3003", name: "Body Side Sub-Assembly Line", customerName: "Hyundai Motors India", value: 12000000, probability: 55, stage: "negotiation", owner: "N. Rao", expectedClose: days(20), createdAt: days(-25) },
      ...
      { id: "o5", code: "OPP-3005", name: "Rear Floor Assembly Cell", customerName: "Bosch Chassis Systems", value: 5400000, probability: 25, stage: "new", owner: "R. Iyer", expectedClose: days(60), createdAt: days(-4) },
    ],
    rfqs: [
      { id: "r1", code: "RFQ-4001", opportunityId: "o1", customerName: "Tata Motors — Pune", title: "EV Battery Tray BIW Line — RFQ", dueDate: days(5), owner: "R. Iyer", status: "in-review", createdAt: days(-9) },
      { id: "r2", code: "RFQ-4002", opportunityId: "o3", customerName: "Hyundai Motors India", title: "Body Side Assembly — RFQ v2", dueDate: days(2), owner: "N. Rao", status: "responded", createdAt: days(-18) },
      { id: "r3", code: "RFQ-4003", opportunityId: "o5", customerName: "Bosch Chassis Systems", title: "Rear Floor Cell — RFQ", dueDate: days(12), owner: "R. Iyer", status: "received", createdAt: days(-2) },
    ],
    proposals: [
      { id: "p1", code: "PRP-5001", rfqId: "r1", customerName: "Tata Motors — Pune", title: "EV Battery Tray BIW — Technical + Commercial", version: "v1.2", owner: "R. Iyer", status: "submitted", createdAt: days(-6) },
      { id: "p2", code: "PRP-5002", rfqId: "r2", customerName: "Hyundai Motors India", title: "Body Side Assembly Proposal", version: "v2.0", owner: "N. Rao", status: "approved", createdAt: days(-15) },
    ],
    quotations: [
      { id: "q1", code: "QUO-6001", proposalId: "p1", customerName: "Tata Motors — Pune", title: "EV Battery Tray BIW — Quotation", value: 8500000, validity: days(20), owner: "R. Iyer", status: "sent", createdAt: days(-4) },
