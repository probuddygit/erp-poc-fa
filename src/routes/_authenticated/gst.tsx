...
export const Route = createFileRoute("/_authenticated/gst")({
  head: () => ({
    meta: [
      { title: "GST & Compliance · YUFLO" },
      { name: "description", content: "GSTR filing calendar, e-invoicing, e-way bills, ITC reconciliation and HSN summaries in YUFLO." },
      { property: "og:title", content: "GST & Compliance · YUFLO" },
